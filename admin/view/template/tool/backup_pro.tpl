		    ...
		    <div class="col-sm-6">
			  <div class="btn-group" data-toggle="buttons">
			    <label class="btn btn-primary active">
				  <input type="radio" name="backup_zip" value="1" checked="checked" />Да
			    </label>
			    <label class="btn btn-primary">
				  <input type="radio" name="backup_zip" value="0" />Нет
			    </label>
			  </div>
			</div>
			<div class="col-sm-3"></div>
		    ...
		    <div class="col-sm-6">
			  <div class="btn-group" data-toggle="buttons">
			    <label class="btn btn-primary <?php if($backup_scheduled_status == '1') {echo 'active';} ?>">
				  <input type="radio" name="backup_scheduled_status" value="1"<?php if($backup_scheduled_status == '1') {echo ' checked="checked"';} ?> />Да
			    </label>
			    <label class="btn btn-primary <?php if($backup_scheduled_status == '0') {echo 'active';} ?>">
				  <input type="radio" name="backup_scheduled_status" value="0"<?php if($backup_scheduled_status == '0') {echo ' checked="checked"';} ?> />Нет
			    </label>
			  </div>
			</div>
			<div class="col-sm-3"></div>
		    ...
		    <div class="col-sm-6">
			  <div class="btn-group" data-toggle="buttons">
			    <label class="btn btn-primary <?php if($backup_scheduled_zip == '1') {echo 'active';} ?>">
				  <input type="radio" name="backup_scheduled_zip" value="1"<?php if($backup_scheduled_zip == '1') {echo ' checked="checked"';} ?> />Да
			    </label>
			    <label class="btn btn-primary <?php if($backup_scheduled_zip == '0') {echo 'active';} ?>">
				  <input type="radio" name="backup_scheduled_zip" value="0"<?php if($backup_scheduled_zip == '0') {echo ' checked="checked"';} ?> />Нет
			    </label>
			  </div>
			</div>
			<div class="col-sm-3"></div>
		    ...
		    <div class="col-sm-6">
			  <div class="btn-group" data-toggle="buttons">
			    <label class="btn btn-primary <?php if($backup_scheduled_cron == '1') {echo 'active';} ?>">
				  <input type="radio" name="backup_scheduled_cron" value="1"<?php if($backup_scheduled_cron == '1') {echo ' checked="checked"';} ?> />Да
			    </label>
			    <label class="btn btn-primary <?php if($backup_scheduled_cron == '0') {echo 'active';} ?>">
				  <input type="radio" name="backup_scheduled_cron" value="0"<?php if($backup_scheduled_cron == '0') {echo ' checked="checked"';} ?> />Нет
			    </label>
			  </div>
			</div>
			<div class="col-sm-3"></div>
